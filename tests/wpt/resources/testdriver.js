...
// (resources/testdriver.js, commit 74b2788f7705a172c25c0261b8ef0055bc61d3f2,
// 2026-07-11), 3-Clause BSD License, https://github.com/web-platform-tests/wpt.
// Shadowed by an external WPT checkout's own copy whenever `--root` lists it
// before `tests/wpt` (see tools/run_wpt_subset.js); kept here only so
// pagecore_wpt_smoke and any `--root tests/wpt`-only run has a client to load.
// If the external checkout's testdriver.js is ever a newer version, refresh
// this copy (and testdriver-actions.js) to match.
(function() {
    "use strict";
    var idCounter = 0;
